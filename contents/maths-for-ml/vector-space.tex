...
\begin{enumerate}
    \item Method 1 \cite{mfml/book/mml/Deisenroth-Faisal-Ong}
    \begin{enumerate}
        \item 
    \end{enumerate}
\end{enumerate}
...
\caption{Gram-Schmidt process VS Gram-Schmidt Orthogonalization} \\

\hline
\textbf{Aspect} & \textbf{Gram-Schmidt Process} & \textbf{Gram-Schmidt Orthogonalization} \\
\hline
\endfirsthead
...
\textbf{Definition} & 
    An algorithm to transform a set of linearly independent vectors into an orthogonal (or orthonormal) set &
    The result or method of obtaining an orthogonal set of vectors from a linearly independent set
    \\ \hline

\textbf{Emphasis} & 
    Focuses on the step-by-step procedure (algorithmic perspective) & 
    Focuses on the outcome or goal (mathematical transformation)
    \\ \hline

\textbf{Output} &
    Sequence of orthogonal (or orthonormal) vectors & 
...
\textbf{Typical Use} & 
    Teaching algorithms, computational steps & 
    Theoretical or geometric discussion
    \\ \hline
