...
\begin{enumerate}
    ...
    \item \textbf{Fewer parameters} $\to$ faster training than LSTM.
    \hfill \cite{common/online/chatgpt}

    \item \textbf{Performs comparably} to LSTM on many tasks.
    \hfill \cite{common/online/chatgpt}

    \item Easier to implement and \textbf{less prone to overfitting}.
    \hfill \cite{common/online/chatgpt}
\end{enumerate}
...
\begin{enumerate}
    \item May perform \textbf{slightly worse} on very long sequences.
    \hfill \cite{common/online/chatgpt}

    \item No explicit cell state $\to$ \textbf{sometimes less interpretable}.
    \hfill \cite{common/online/chatgpt}
\end{enumerate}
...
\begin{enumerate}
    \item For tasks needing very long dependencies or finer control, use LSTM.
    \hfill \cite{common/online/chatgpt}
\end{enumerate}
