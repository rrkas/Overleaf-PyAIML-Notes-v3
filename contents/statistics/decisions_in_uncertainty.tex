...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item If $p\leq\alpha$: Reject $H_0$ $\to$ conclude that the variances are not equal.
        \hfill \cite{common/online/chatgpt}

        \item If $p>\alpha$: Fail to reject $H_0$ $\to$ no evidence against equal variances.
        \hfill \cite{common/online/chatgpt}
    \end{enumerate}
\end{enumerate}
...
\subsection{Bayes’ Law for Competing Hypotheses}
