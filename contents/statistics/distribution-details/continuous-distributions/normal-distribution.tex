...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item If p-value $\leq \alpha$: Reject $H_0$ $\to$ Evidence suggests a difference in means.
        \hfill \cite{common/online/chatgpt}

        \item If p-value $> \alpha$: Fail to reject $H_0$ $\to$ Not enough evidence to conclude a difference.
        \hfill \cite{common/online/chatgpt}
    \end{enumerate}
\end{enumerate}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item $p\leq \alpha (e.g., 0.05)$: Reject $H_0$ $\to$ Data not normal (significant deviation from normality)
        \hfill \cite{common/online/chatgpt}

        \item $p>\alpha$: Fail to reject $H_0$ $\to$ No evidence against normality (data likely normal)
        \hfill \cite{common/online/chatgpt}
    \end{enumerate}
\end{enumerate}
...
\begin{enumerate}
    ...
    \hfill \cite{common/online/chatgpt}
    \begin{enumerate}
        \item If $G>c_\alpha$: Reject $H_0$ (no outliers) $\to$ The data point corresponding to $G$ is an outlier.
        \hfill \cite{common/online/chatgpt}

        \item If $G\leq c_\alpha$: Fail to reject $H_0$ $\to$ No significant outlier.
        \hfill \cite{common/online/chatgpt}
    \end{enumerate}
