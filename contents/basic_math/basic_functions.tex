...
\section{Absolute Value function/ Modulus Function ( $\dabs{x}$ ) \cite{basic-maths/online/wiki/Absolute-value}}\label{Basic Functions/Absolute Value function or Modulus Function}
...
\begin{table}[H]
    ...
    \begin{minipage}{0.55\linewidth}
        \begin{figure}[H]
            ...
            \caption{Absolute Value function/ Modulus Function \cite{basic-maths/online/wiki/Absolute-value}}
        \end{figure}
    \end{minipage}
\end{table}
...
\subsubsection*{Fundamental properties \cite{basic-maths/online/wiki/Absolute-value}} \label{Basic Functions/Absolute Value function or Modulus Function/Fundamental properties}
