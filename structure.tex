...
{\contentslabel[\thecontentslabel]{0.75cm}\color{black}} % Display chapter numbers in large size with custom color
...
{\contentslabel[\thecontentslabel]{1cm}\color{black}} % Display section numbers with appropriate alignment
...
{\contentslabel[\thecontentslabel]{1.25cm}\color{black}} % Display subsection numbers with alignment
...
{\contentslabel[\thecontentslabel]{1cm}\color{black}} % Display subsubsection numbers with alignment
...
{\contentslabel[\thecontentslabel]{1cm}\color{black}} % Display paragraph numbers with alignment
