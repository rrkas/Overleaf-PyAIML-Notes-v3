...
% % use LuaLaTex/ XeLaTex
% \usepackage{emoji} % https://2.mirrors.in.sahilister.net/ctan/macros/luatex/latex/emoji/emoji-doc.pdf

% \usepackage{hwemoji} % Loads emoji support
