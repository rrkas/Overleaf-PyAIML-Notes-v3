...
\def\@makechapterhead#1{%
  ...
  {\parindent \z@ \centering % No paragraph indent, center align the chapter title
    ...
    % \vskip 10\p@ % Add 40pt space below the chapter title
  }}
...
\def\@makeschapterhead#1{%
  \vspace*{10\p@}% Add 20pt space above the chapter title
...
\usepackage{tocloft} % Package to manage table of contents formatting
...
\newcommand{\partition}[1]{ % #1 is the argument for the partition name
    ...
    \begin{center}
        {\centering \fontsize{30}{30}\selectfont Part \thepartitioncounter} \\[1cm] % Display "Part I, Part II..." in large, bold font

        {\fontsize{50}{50} \selectfont \textsc{#1}} % Display the partition title in a smaller but bold font, 1cm below
    \end{center}
    ...
    \addtocontents{toc}{
        \protect\contentsline{chapter}{
            \fontsize{17}{17}\selectfont \textbf{Part \thepartitioncounter: #1}
        }{}{}
    }
}
