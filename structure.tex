...
\newcommand{\authorbook}{{\color{blue}\textbf{\bookname}} \textit{by} \textbf{\authorname}}
...
\fancypagestyle{mainmatter}{    
    ...
    \fancyhead[L]{{\color{blue}\textbf{\bookname}}} % Left side: Book title in blue
...
\hypersetup{
    ...
    pdftitle={\bookname}, % Set the title of the PDF
    pdfauthor={\authorname} % Set the author name in the PDF metadata
}
